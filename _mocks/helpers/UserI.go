...
// GetByRoaster provides a mock function with given fields: _a0
func (_m *UserI) GetByRoaster(_a0 string) (*models.User, error) {
	ret := _m.Called(_a0)
...
func (_m *UserI) Profile(_a0 string, _a1 string, _a2 multipart.File) error {
